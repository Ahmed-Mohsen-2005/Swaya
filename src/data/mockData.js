export const users = [
  { id:'user_teacher_001', fullName:'Mona Hassan', email:'teacher@swaya.demo', password:'demo123', role:'teacher', linkedClassIds:['class_001'], linkedStudentIds:['stu_001','stu_002','stu_003','stu_004','stu_005','stu_006','stu_007','stu_008'] },
  { id:'user_doctor_001', fullName:'Dr. Ahmed Sami', email:'doctor@swaya.demo', password:'demo123', role:'doctor', linkedStudentIds:['stu_001','stu_002','stu_006','stu_008'] },
  { id:'user_parent_001', fullName:"Abdullah's Parent", email:'parent@swaya.demo', password:'demo123', role:'parent', linkedStudentIds:['stu_001'] }
];
...
export const students = [
  { id:'stu_001', fullName:'Abdullah Ali', shortName:'Abdullah', age:8, gender:'male', classification:'ASD', autismLevel:'moderate', classId:'class_001', parentIds:['user_parent_001'], teacherIds:['user_teacher_001'], doctorIds:['user_doctor_001'], status:'needs_attention', avatar:'🧒', baselineMetrics:{attention:64,engagement:58,stress:38,socialInteraction:48}},
  { id:'stu_002', fullName:'Sara M.', shortName:'Sara', age:8, gender:'female', classification:'ASD', autismLevel:'mild', classId:'class_001', parentIds:[], teacherIds:['user_teacher_001'], doctorIds:['user_doctor_001'], status:'stable', avatar:'👧', baselineMetrics:{attention:66,engagement:61,stress:35,socialInteraction:52}},
  { id:'stu_003', fullName:'Omar H.', shortName:'Omar', age:9, gender:'male', classification:'Typical', autismLevel:'not_applicable', classId:'class_001', parentIds:[], teacherIds:['user_teacher_001'], doctorIds:[], status:'stable', avatar:'👦', baselineMetrics:{attention:78,engagement:82,stress:24,socialInteraction:75}},
  { id:'stu_004', fullName:'Layla K.', shortName:'Layla', age:8, gender:'female', classification:'ASD', autismLevel:'mild', classId:'class_001', parentIds:[], teacherIds:['user_teacher_001'], doctorIds:[], status:'stable', avatar:'👧', baselineMetrics:{attention:70,engagement:76,stress:28,socialInteraction:63}},
  { id:'stu_005', fullName:'Youssef T.', shortName:'Youssef', age:9, gender:'male', classification:'Typical', autismLevel:'not_applicable', classId:'class_001', parentIds:[], teacherIds:['user_teacher_001'], doctorIds:[], status:'stable', avatar:'👦', baselineMetrics:{attention:69,engagement:72,stress:30,socialInteraction:70}},
  { id:'stu_006', fullName:'Noor A.', shortName:'Noor', age:8, gender:'female', classification:'ASD', autismLevel:'moderate', classId:'class_001', parentIds:[], teacherIds:['user_teacher_001'], doctorIds:['user_doctor_001'], status:'needs_attention', avatar:'👧', baselineMetrics:{attention:55,engagement:52,stress:50,socialInteraction:43}},
  { id:'stu_007', fullName:'Ibrahim S.', shortName:'Ibrahim', age:9, gender:'male', classification:'Typical', autismLevel:'not_applicable', classId:'class_001', parentIds:[], teacherIds:['user_teacher_001'], doctorIds:[], status:'stable', avatar:'👦', baselineMetrics:{attention:75,engagement:77,stress:22,socialInteraction:72}},
  { id:'stu_008', fullName:'Hana M.', shortName:'Hana', age:8, gender:'female', classification:'ASD', autismLevel:'mild', classId:'class_001', parentIds:[], teacherIds:['user_teacher_001'], doctorIds:['user_doctor_001'], status:'stable', avatar:'👧', baselineMetrics:{attention:66,engagement:70,stress:29,socialInteraction:60}}
];
