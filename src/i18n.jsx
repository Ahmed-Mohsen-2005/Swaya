...
const ar = {
  ...
  'Add lesson context before or during a session': 'أضف سياق الدرس قبل الجلسة أو أثناءها',
  'Add the lesson or activity plan so SWAYA can support students based on classroom context.': 'أضف خطة الدرس أو النشاط ليتمكن سوايا من دعم الطلاب بناءً على سياق الحصة.',
  'Arabic-first planning': 'مرتبطة بسياق الحصة',
  'Linked to session context': 'مرتبطة بسياق الحصة',
  'Added Plans': 'الخطط المضافة',
  'Latest Plan': 'آخر خطة',
  'Ready Templates': 'قوالب جاهزة',
  'Linked to Live Session': 'مرتبطة بجلسة مباشرة',
  'Add Study Plan': 'إضافة خطة دراسية',
  'Choose how you want to provide the lesson context.': 'اختر طريقة إضافة سياق الدرس.',
  'Upload File': 'رفع ملف',
  'Write Manually': 'كتابة يدوية',
  'Choose Template': 'اختيار قالب',
  'Drag the plan file here or click to choose': 'اسحب ملف الخطة هنا أو اضغط للاختيار',
  'Supports PDF, Word, and images': 'يدعم PDF و Word والصور',
  'Maximum size 10MB': 'الحد الأقصى 10MB',
  'Please choose a file.': 'يرجى اختيار ملف.',
  'Unsupported file type.': 'نوع الملف غير مدعوم.',
  'Unsupported file type': 'نوع الملف غير مدعوم',
  'File size must be 10MB or less.': 'يجب ألا يتجاوز حجم الملف 10MB.',
  'File size exceeds the allowed limit': 'حجم الملف أكبر من الحد المسموح',
  'Study plan saved successfully.': 'تم حفظ الخطة الدراسية بنجاح.',
  'Study plan updated successfully.': 'تم تحديث الخطة الدراسية بنجاح.',
  'Study plan selected for live session.': 'تم اختيار الخطة للجلسة المباشرة.',
  'The plan has been linked to the live session': 'تم ربط الخطة بالجلسة المباشرة',
  'Plan title is required.': 'عنوان الخطة مطلوب.',
  'Template applied. You can edit it before saving.': 'تم تطبيق القالب. يمكنك تعديله قبل الحفظ.',
  'Plan Title': 'عنوان الخطة',
  'Grade / Group': 'الصف/المجموعة',
  'Session Date': 'تاريخ الحصة',
  'Session Duration': 'مدة الحصة',
  'Lesson Goals': 'أهداف الدرس',
  'Activity Steps': 'خطوات النشاط',
  'Required Materials': 'المواد المطلوبة',
  'Follow-up Notes': 'ملاحظات للمتابعة',
  'Students needing special support': 'الطلاب الذين يحتاجون دعمًا خاصًا',
  'Select one or more students': 'اختر طالبًا أو أكثر',
  'Search student...': 'ابحث عن طالب...',
  'No matching students': 'لا يوجد طلاب مطابقون',
  'No students selected': 'لم يتم اختيار طلاب',
  'Support students': 'طلاب الدعم',
  'No support students selected': 'لا يوجد طلاب دعم محددون',
  'selected': 'محدد',
  'Remove student': 'إزالة الطالب',
  'Remove file': 'إزالة الملف',
  'Update Plan': 'تحديث الخطة',
  'Cancel': 'إلغاء',
  'Use Template': 'استخدام القالب',
  'Recent Plans': 'الخطط الأخيرة',
  'Saved lesson context for upcoming and live sessions.': 'سياق الدرس المحفوظ للجلسات القادمة والمباشرة.',
  'Plan Preview': 'معاينة الخطة',
  'Review the selected study plan before using it.': 'راجع الخطة المحددة قبل استخدامها.',
  'No study plans yet': 'لا توجد خطط دراسية بعد',
  'Upload, write, or choose a template to create the first study plan.': 'ارفع ملفًا أو اكتب يدويًا أو اختر قالبًا لإنشاء أول خطة.',
  'No plan selected': 'لم يتم اختيار خطة',
  'Choose View from a recent plan to preview it here.': 'اختر عرض من خطة حديثة لمعاينتها هنا.',
  'Use in Live Session': 'استخدام في الجلسة المباشرة',
  'File': 'ملف',
  'Manual': 'يدوي',
  'Template': 'قالب',
  'Saved': 'محفوظ',
  'Used in Session': 'مستخدم في جلسة',
  'Pending Review': 'بانتظار المراجعة',
  'Linked session': 'الجلسة المرتبطة',
  'Lesson context for this live session': 'سياق الدرس لهذه الجلسة المباشرة',
  'Choose Plan': 'اختيار خطة',
  'No study plan selected for this session': 'لم يتم اختيار خطة دراسية لهذه الجلسة',
  'Activity type': 'نوع النشاط',
  'Support Notes': 'ملاحظات الدعم',
  'Plan used': 'الخطة المستخدمة',
  'No linked plan': 'لا توجد خطة مرتبطة',
  'min': 'دقيقة',
  'Overview': 'نظرة عامة',
